export const texts = {
    zh: {
        ...
        condOp: '比较',
        condRight: '目标值',
        previewInput: '输入 (原生返回)',
        previewOutput: '输出 (封装结果)',
        runTest: '运行测试',
        key: '参数名',
        type: '类型',
        required: '必填',
    ...
    en: {
        ...
        pre: 'Pre-Hook',
        post: 'Post-Hook',
        responseTransform: 'Encapsulation Rules',
        outputPreview: 'Preview',
        ruleName: 'Rule Name',
        triggerCond: 'Trigger Condition',
        condLeft: 'Expression',
        condOp: 'Operator',
        condRight: 'Value',
        previewInput: 'Input (Native)',
        previewOutput: 'Output (Result)',
        runTest: 'Run Test',
        key: 'Key',
        type: 'Type',
        required: 'Required',
